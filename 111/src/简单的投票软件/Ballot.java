...
class MyMin extends JFrame implements ActionListener {
    ...
    public MyMin() { // 在构造方法中设置窗体布局
        ...
        candidateOne = new Candidate("小兵", new ImageIcon("你们要的女孩子！【第八期图包】\\1 (39).jpg"));
        candidateTwo = new Candidate("小陈", new ImageIcon("你们要的女孩子！【第八期图包】\\1 (40).jpg"));
        candidateThree = new Candidate("小李", new ImageIcon("你们要的女孩子！【第八期图包】\\1 (42).jpg"));
        candidateOne.setSelectedIcon(new ImageIcon("你们要的女孩子！【第八期图包】\\1 (39).jpg"));
        candidateTwo.setSelectedIcon(new ImageIcon("你们要的女孩子！【第八期图包】\\1 (40).jpg"));
        candidateThree.setSelectedIcon(new ImageIcon("你们要的女孩子！【第八期图包】\\1 (42).jpg"));
